...
public class Final1 extends Java3dApplet{
    ...
    Plot1_mx=80;
    Plot1_my=Plot1_yc/Plot1_xc*80;
    Plot1_mz=Plot1_zc/Plot1_xc*80;
    }
    ...
    protected BranchGroup Plot1_createSceneBranchGroup() {
       ...
       la.setLineAntialiasingEnable(true);
        ...
        cuboid[8]=Plot1_rotate(Plot1_xc,Plot1_yc,0,0);
        cuboid[9]=Plot1_rotate(0,Plot1_yc,0,0);
        
        
        cuboid[10]=Plot1_rotate(Plot1_xc,Plot1_yc,Plot1_zc,0);
        cuboid[11]=Plot1_rotate(Plot1_xc,Plot1_yc,0,0);
        
        cuboid[12]=Plot1_rotate(0,Plot1_yc,Plot1_zc,0);
        cuboid[13]=Plot1_rotate(0,Plot1_yc,0,0);
        
                
        LineArray cub = new LineArray(14, LineArray.COORDINATES);
        cub.setCoordinates(0, cuboid);
        Shape3D plShape1 = new Shape3D(cub, app);
        objRoot.addChild(plShape1);
        
        Appearance ap = new Appearance();
        ColoringAttributes caa = new ColoringAttributes(new Color3f(0.2f,0.2f,0.2f),ColoringAttributes.SHADE_FLAT);
      
        ap.setLineAttributes(la);
        ap.setColoringAttributes(caa);
        Point3d[] cuboidb=new Point3d[10];
           
        cuboidb[0]=Plot1_rotate(Plot1_xc,0,0,0);
        cuboidb[1]=Plot1_rotate(Plot1_xc,Plot1_yc,0,0);
        
        cuboidb[2]=Plot1_rotate(Plot1_xc,0,Plot1_zc,0);
        cuboidb[3]=Plot1_rotate(Plot1_xc,0,0,0);
      
        
        cuboidb[4]=Plot1_rotate(0,Plot1_yc,0,0);
        cuboidb[5]=Plot1_rotate(0,0,0,0);
        
        cuboidb[6]=Plot1_rotate(0,0,0,0);
        cuboidb[7]=Plot1_rotate(Plot1_xc,0,0,0);
        
        cuboidb[8]=Plot1_rotate(0,0,Plot1_zc,0);
        cuboidb[9]=Plot1_rotate(0,0,0,0);
        

        LineArray cu = new LineArray(10, LineArray.COORDINATES);
        cu.setCoordinates(0, cuboidb);
        Shape3D pShape1 = new Shape3D(cu, ap);
        objRoot.addChild(pShape1);
        
        
        Point3d[] cuboid2=new Point3d[14];
        ...
        cuboid2[8]=Plot1_rotate2(Plot1_xc,Plot1_yc,0,0);
        cuboid2[9]=Plot1_rotate2(0,Plot1_yc,0,0);
        
        
        cuboid2[10]=Plot1_rotate2(Plot1_xc,Plot1_yc,Plot1_zc,0);
        cuboid2[11]=Plot1_rotate2(Plot1_xc,Plot1_yc,0,0);
        
        cuboid2[12]=Plot1_rotate2(0,Plot1_yc,Plot1_zc,0);
        cuboid2[13]=Plot1_rotate2(0,Plot1_yc,0,0);
        LineArray cub2 = new LineArray(14, LineArray.COORDINATES);
        ...
        Point3d[] cuboidb2=new Point3d[10];
           
        cuboidb2[0]=Plot1_rotate2(Plot1_xc,0,0,0);
        cuboidb2[1]=Plot1_rotate2(Plot1_xc,Plot1_yc,0,0);
        
        cuboidb2[2]=Plot1_rotate2(Plot1_xc,0,Plot1_zc,0);
        cuboidb2[3]=Plot1_rotate2(Plot1_xc,0,0,0);
      
        
        cuboidb2[4]=Plot1_rotate2(0,Plot1_yc,0,0);
        cuboidb2[5]=Plot1_rotate2(0,0,0,0);
        
        cuboidb2[6]=Plot1_rotate2(0,0,0,0);
        cuboidb2[7]=Plot1_rotate2(Plot1_xc,0,0,0);
        
        cuboidb2[8]=Plot1_rotate2(0,0,Plot1_zc,0);
        cuboidb2[9]=Plot1_rotate2(0,0,0,0);
        

        LineArray cu2 = new LineArray(10, LineArray.COORDINATES);
        cu2.setCoordinates(0, cuboidb2);
        Shape3D pShape12 = new Shape3D(cu2, ap);
        tg.addChild(pShape12);
    ...
    */
    //body
      ...
      Point3d[] bdy=new Point3d[24];
        ...
        tg2.addChild(shape2);
float xi=Plot1_xc/Plot1_mx,yi=Plot1_yc/Plot1_my,zi=Plot1_zc/Plot1_mz;
Appearance app3 = new Appearance();
ColoringAttributes ca3 = new ColoringAttributes(new Color3f(0.0f,0.0f,0.0f),ColoringAttributes.SHADE_FLAT);
...
Plot1_zc+=1;
                    ...
                    for(float i=0;i<Plot1_xc;i+=xi)
                        {    Point3d[] plaPts = new Point3d[4];
                    plaPts[0] = Plot1_rotate(i,Plot1_yc, Plot1_zc,0);
                    plaPts[1] = Plot1_rotate(i, 0, Plot1_zc,0);
                    plaPts[2] = Plot1_rotate(i,Plot1_yc, 0,0);
                    plaPts[3] = Plot1_rotate(i, 0,0,0);
                    
                    LineArray pla = new LineArray(4, LineArray.COORDINATES);
                    pla.setCoordinates(0, plaPts);
                    Shape3D plShape = new Shape3D(pla, app3);
                    objRoot.addChild(plShape);
                    }    
                        for(float i=0;i<Plot1_yc;i+=yi)
                    {    Point3d[] plaPts = new Point3d[4];
                    plaPts[0] = Plot1_rotate(Plot1_xc,i, Plot1_zc,0);
                    plaPts[1] = Plot1_rotate(0, i, Plot1_zc,0);
                    plaPts[2] = Plot1_rotate(Plot1_xc,i, 0,0);
                    plaPts[3] = Plot1_rotate(0, i,0,0);
      ...
      //mesh xz plane
        for(float i=0;i<Plot1_xc;i+=xi)
            {    Point3d[] plaPts = new Point3d[4];
        plaPts[0] = Plot1_rotate(i,0, Plot1_zc,0);
        plaPts[1] = Plot1_rotate(i, 0, 0,0);
        plaPts[2] = Plot1_rotate(i,Plot1_yc, Plot1_zc,0);
        plaPts[3] = Plot1_rotate(i,Plot1_yc,0,0);
        ...
        {    Point3d[] plaPts = new Point3d[4];
        plaPts[0] = Plot1_rotate(Plot1_xc,Plot1_yc, i,0);
        plaPts[1] = Plot1_rotate(0, Plot1_yc, i,0);
        plaPts[2] = Plot1_rotate(Plot1_xc,0, i,0);
        plaPts[3] = Plot1_rotate(0, 0,i,0);
        ...
        objRoot.addChild(plShape);
          ...
          //mesh yz plane
            for(float i=0;i<Plot1_yc;i+=yi)
                ...
                {    Point3d[] plaPts = new Point3d[4];
            plaPts[0] = Plot1_rotate(0,i, Plot1_zc,0);
            plaPts[1] = Plot1_rotate(0, i, 0,0);
            plaPts[2] = Plot1_rotate(Plot1_xc,i, Plot1_zc,0);
            plaPts[3] = Plot1_rotate(Plot1_xc,i,0,0);
            ...
            objRoot.addChild(plShape);
                ...
                for(float i=0;i<Plot1_zc;i+=zi)
            {    Point3d[] plaPts = new Point3d[4];
            plaPts[0] = Plot1_rotate(0,Plot1_yc, i,0);
            plaPts[1] = Plot1_rotate(0.0f,0.0f, i,0);
            plaPts[2] = Plot1_rotate(Plot1_xc,Plot1_yc, i,0);
            plaPts[3] = Plot1_rotate(Plot1_xc, 0,i,0);
...
//left wing  
                ...
                for(float i=0;i<Plot1_xc;i+=xi)
                    {    Point3d[] plaPts = new Point3d[4];
                plaPts[0] = Plot1_rotate2(i,Plot1_yc, Plot1_zc,0);
                plaPts[1] = Plot1_rotate2(i, 0, Plot1_zc,0);
                plaPts[2] = Plot1_rotate2(i,Plot1_yc, 0,0);
                plaPts[3] = Plot1_rotate2(i, 0,0,0);
                ...
                tg.addChild(plShape);
                    ...
                    for(float i=0;i<Plot1_yc;i+=yi)
                {    Point3d[] plaPts = new Point3d[4];
                plaPts[0] = Plot1_rotate2(Plot1_xc,i, Plot1_zc,0);
                plaPts[1] = Plot1_rotate2(0, i, Plot1_zc,0);
                plaPts[2] = Plot1_rotate2(Plot1_xc,i, 0,0);
                plaPts[3] = Plot1_rotate2(0, i,0,0);
  ...
  //mesh xz plane
    for(float i=0;i<Plot1_xc;i+=xi)
        {    Point3d[] plaPts = new Point3d[4];
    plaPts[0] = Plot1_rotate2(i,0, Plot1_zc,0);
    plaPts[1] = Plot1_rotate2(i, 0, 0,0);
    plaPts[2] = Plot1_rotate2(i,Plot1_yc, Plot1_zc,0);
    plaPts[3] = Plot1_rotate2(i,Plot1_yc,0,0);
    ...
    tg.addChild(plShape);
        ...
        for(float i=0;i<Plot1_zc;i+=zi)
    {    Point3d[] plaPts = new Point3d[4];
    plaPts[0] = Plot1_rotate2(Plot1_xc,Plot1_yc, i,0);
    plaPts[1] = Plot1_rotate2(0, Plot1_yc, i,0);
    plaPts[2] = Plot1_rotate2(Plot1_xc,0, i,0);
    plaPts[3] = Plot1_rotate2(0, 0,i,0);
    ...
    tg.addChild(plShape);
      ...
      //mesh yz plane
        for(float i=0;i<Plot1_yc;i+=yi)
            ...
            {    Point3d[] plaPts = new Point3d[4];
        plaPts[0] = Plot1_rotate2(0,i, Plot1_zc,0);
        plaPts[1] = Plot1_rotate2(0, i, 0,0);
        plaPts[2] = Plot1_rotate2(Plot1_xc,i, Plot1_zc,0);
        plaPts[3] = Plot1_rotate2(Plot1_xc,i,0,0);
        ...
        tg.addChild(plShape);
            ...
            for(float i=0;i<Plot1_zc;i+=zi)
        {    Point3d[] plaPts = new Point3d[4];
        plaPts[0] = Plot1_rotate2(0,Plot1_yc, i,0);
        plaPts[1] = Plot1_rotate2(0.0f,0.0f, i,0);
        plaPts[2] = Plot1_rotate2(Plot1_xc,Plot1_yc, i,0);
        plaPts[3] = Plot1_rotate2(Plot1_xc, 0,i,0);
